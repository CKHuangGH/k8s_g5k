...
ssh -o StrictHostKeyChecking=no root@$j chmod 777 -R /root/mck8s_vm/saci/
...
scp chuang@172.16.207.100:/home/chuang/node_list /home/chuang/node_list_nantes
cat node_list_nantes >> node_list
